# YPCB Vivado golden DDR3 c0.group2.A placement tuple.
#
# Extracted from:
#   artifacts/task6/vivado-golden/ypcb-00338-1p1-systest-2026-05-16/
#     reverse-engineering/golden-hardmacro-summary.json
#
# This keeps the lane-0 DQS PHASEREF path on PHASER_IN_PHY_X0Y0, but aligns
...
if missing:
    raise RuntimeError(
        "YPCB PHASER DDR3 golden c0.group2.A pre-place missing cells: "
        + repr(missing)
    )
...
print("YPCB PHASER DDR3 golden c0.group2.A pre-place: applied {} locks".format(applied))
