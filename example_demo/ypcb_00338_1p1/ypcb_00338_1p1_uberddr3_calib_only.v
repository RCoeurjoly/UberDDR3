...
`ifndef YPCB_CALIB_DEBUG_WB_DATA_SNAPSHOT_ENABLE
`define YPCB_CALIB_DEBUG_WB_DATA_SNAPSHOT_ENABLE 0
`endif

`ifndef YPCB_CALIB_ISOLATE_WB_UNTIL_CALIB_DONE
`define YPCB_CALIB_ISOLATE_WB_UNTIL_CALIB_DONE 0
`endif
...
module ypcb_00338_1p1_uberddr3_calib_only (
  ...
  task6_ypcb_uberddr3_calib_only_top #(
        ...
        .DEBUG_WB_DATA_SNAPSHOT_ENABLE(`YPCB_CALIB_DEBUG_WB_DATA_SNAPSHOT_ENABLE),
        .ISOLATE_WB_UNTIL_CALIB_DONE(`YPCB_CALIB_ISOLATE_WB_UNTIL_CALIB_DONE)
    ) calib_top (
        .clk50(clk50),
        .SYS_RSTN(rst_n),
        .ddram_a(ddr3_addr),
