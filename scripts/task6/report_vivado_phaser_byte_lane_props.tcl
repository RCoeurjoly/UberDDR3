...
if {$argc != 2} {
    error "usage: report_vivado_phaser_byte_lane_props.tcl <checkpoint.dcp> <out.txt>"
}
...
emit_cell_props $fp phaser_ref_i {
    IS_CLK_INVERTED
    IS_PWRDWN_INVERTED
    IS_RST_INVERTED
}

emit_cell_props $fp phy_control_i {
    BURST_MODE
    CLK_RATIO
...
emit_cell_props $fp phaser_in_i {
    CLKOUT_DIV
    DQS_BIAS
    FINE_DELAY
    FREQ_REF_DIV
...
emit_cell_props $fp phaser_out_i {
    CLKOUT_DIV
    COARSE_BYPASS
    DATA_CTL_N
    DATA_RD_CYCLES
