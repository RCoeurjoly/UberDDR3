...
OUT="${OUT:-${ROOT}/artifacts/task6/litedram-reference/ypcb-jtagbone-smoke}"
...
python3 "${ROOT}/scripts/task6/ypcb_litex_jtagbone_smoke.py" \
  --output-dir "${OUT}" \
  "$@"

printf 'Generated YPCB LiteX JTAGBone smoke design in %s\n' "${OUT}"
