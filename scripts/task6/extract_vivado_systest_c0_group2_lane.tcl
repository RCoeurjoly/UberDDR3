# Extract focused Vivado SYSTEST evidence for a c0.group2 PHASER/FIFO lane.
#
# Usage:
#   vivado -mode batch -nojournal -nolog \
#     -source scripts/task6/extract_vivado_systest_c0_group2_lane.tcl \
#     -tclargs <routed.dcp> <out_dir> <A|B>
...
if {$argc != 3} {
    error "usage: extract_vivado_systest_c0_group2_lane.tcl <routed.dcp> <out_dir> <A|B>"
}

set dcp_path [lindex $argv 0]
set out_dir [lindex $argv 1]
set lane_name [string toupper [lindex $argv 2]]
if {$lane_name ne "A" && $lane_name ne "B"} {
    error "lane must be A or B"
}
file mkdir $out_dir
open_checkpoint $dcp_path

set lane_prefix "top_i/mig_7series_0/u_top_mig_7series_0_0_mig/c0_u_memc_ui_top_axi/mem_intfc0/ddr_phy_top0/u_ddr_mc_phy_wrapper/u_ddr_mc_phy/ddr_phy_4lanes_2.u_ddr_phy_4lanes/ddr_byte_lane_${lane_name}.ddr_byte_lane_${lane_name}"
