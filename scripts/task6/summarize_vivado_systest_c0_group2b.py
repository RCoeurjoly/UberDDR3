#!/usr/bin/env python3
"""Summarize focused c0.group2.B SYSTEST PHASER/FIFO extraction."""
...
def load_extract(extract_dir: Path) -> dict[str, Any]:
    ...
    return {
        "schema": "vivado-systest-c0-group2b-focused-v1",
...
def emit_markdown(summary: dict[str, Any], out: Path) -> None:
    lines = [
        "# SYSTEST c0.group2.B Focused PHASER/FIFO Extract",
        "",
    ...
    lines.extend([
        ...
        "- `c0.group2.B` uses the X0Y1 PHASER/FIFO tuple, but its `PHY_CONTROL` is the shared group-2 instance at `PHY_CONTROL_X0Y0`.",
