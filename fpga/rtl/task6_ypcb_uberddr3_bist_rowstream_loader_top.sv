...
module task6_ypcb_uberddr3_bist_rowstream_loader_top #(
  ...
  localparam logic [7:0] JTAG_DEBUG_VERSION = 8'd71;
      ...
      if (
        ...
        READ_PROBE_ISSUE_READ: begin
          ...
          if (wb_ack) begin
            ...
            read_probe_cyc_q <= 1'b0;
            read_probe_data_q <= wb_data[31:0];
  ...
  always_ff @(posedge controller_clk or negedge rst_n) begin
    if (!rst_n) begin
      ...
      debug_word240_q <=
        ...
        wb2_debug_done_q ? wb2_debug_data_q : read_probe_data_q;
