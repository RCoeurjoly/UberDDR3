...
echo '## 5: seed5-pass pass clocking all   6824.0 ps'
...
echo '## 6: seed5-pass pass clocking all   6824.0 ps'
...
echo '## 7: seed1-robust robust clocking all   5985.0 ps'
...
echo '## 8: seed2-robust robust clocking all   5519.0 ps'
...
echo '## 9: seed3-pass pass clocking all   5429.0 ps'
...
echo '## 10: seed4-pass pass clocking all   5429.0 ps'
...
echo '## 11: seed4-pass pass clocking all   5429.0 ps'
...
echo '## 12: seed1-fail fail clocking all   5159.0 ps'
...
echo '## 13: seed5-pass pass clocking all   5130.0 ps'
...
echo '## 14: seed2-fail fail clocking all   4994.0 ps'
...
echo '## 15: seed2-fail fail clocking all   4949.0 ps'
...
echo '## 16: seed4-pass pass clocking all   4949.0 ps'
...
echo '## 17: seed5-pass pass clocking all   4875.0 ps'
...
echo '## 18: seed3-pass pass clocking all   4635.0 ps'
...
echo '## 19: seed3-pass pass clocking all   4635.0 ps'
...
echo '## 20: seed3-pass pass clocking all   4635.0 ps'
...
echo '## 21: seed3-pass pass clocking all   4349.0 ps'
...
echo '## 22: seed3-pass pass clocking all   3822.0 ps'
...
echo '## 23: seed1-robust robust clocking all   3690.0 ps'
...
echo '## 24: seed1-fail fail dq_iologic lane0 dq4  3608.0 ps'
...
echo '## 25: seed1-fail fail dq_iologic lane0 dq4  3608.0 ps'
...
echo '## 26: seed5-pass pass idelayctrl all   3525.0 ps'
sdf-toolkit rank-paths result-sdf-seed5-pass/ypcb_00338_1p1_ddr3.cvc.sdf 'ddr3_top_inst\.ddr3_phy_inst\.IDELAYCTRL_inst\$intcell\$CTRL_DUP_0.RDY' '\$auto\$abc9_ops\.cc\:1550\:reintegrate\$179476.A1' --limit 10

echo '## 27: seed5-pass pass idelayctrl all   3525.0 ps'
sdf-toolkit rank-paths result-sdf-seed5-pass/ypcb_00338_1p1_ddr3.cvc.sdf 'ddr3_top_inst\.ddr3_phy_inst\.IDELAYCTRL_inst\$intcell\$CTRL_DUP_0.RDY' '\$abc\$179448\$lut\$aiger179447\$4266.A2' --limit 10

echo '## 28: seed5-pass pass idelayctrl all   3509.0 ps'
sdf-toolkit rank-paths result-sdf-seed5-pass/ypcb_00338_1p1_ddr3.cvc.sdf 'ddr3_top_inst\.ddr3_phy_inst\.IDELAYCTRL_inst\$intcell\$CTRL_DUP_0.RDY' '\$auto\$abc9_ops\.cc\:1550\:reintegrate\$180074.A1' --limit 10

echo '## 29: seed5-pass pass clocking all   3509.0 ps'
sdf-toolkit rank-paths result-sdf-seed5-pass/ypcb_00338_1p1_ddr3.cvc.sdf 'clk_wiz_inst\.plle2_adv_inst.LOCKED' '\$auto\$xilinx_dffopt\.cc\:338\:execute\$184236.A2' --limit 10

echo '## 30: seed1-fail fail dq_iologic lane0 dq1  3444.0 ps'
...
echo '## 31: seed1-fail fail dq_iologic lane0 dq1  3444.0 ps'
...
echo '## 32: seed1-fail fail clocking all   3420.0 ps'
...
echo '## 33: seed2-robust robust clocking all   3420.0 ps'
...
echo '## 34: seed1-fail fail dq_iologic lane1 dq15  3417.0 ps'
...
echo '## 35: seed1-fail fail dq_iologic lane1 dq15  3417.0 ps'
...
echo '## 36: seed2-robust robust dqs_iologic lane1 dqs1  3404.0 ps'
...
echo '## 37: seed2-robust robust dqs_iologic lane1 dqs1  3404.0 ps'
...
echo '## 38: seed2-fail fail clocking all   3390.0 ps'
...
echo '## 39: seed1-fail fail dqs_iologic lane1 dqs1  3378.0 ps'
...
echo '## 40: seed1-fail fail dqs_iologic lane1 dqs1  3378.0 ps'
...
echo '## 41: seed1-fail fail idelayctrl all   3371.0 ps'
...
echo '## 42: seed1-fail fail dq_iologic lane1 dq12  3240.0 ps'
...
echo '## 43: seed1-fail fail dq_iologic lane1 dq12  3240.0 ps'
...
echo '## 44: seed1-robust robust clocking all   3237.0 ps'
...
echo '## 45: seed3-pass pass dq_iologic lane1 dq8  3213.0 ps'
...
echo '## 46: seed3-pass pass dq_iologic lane1 dq8  3213.0 ps'
...
echo '## 47: seed5-pass pass clocking all   3184.0 ps'
sdf-toolkit rank-paths result-sdf-seed5-pass/ypcb_00338_1p1_ddr3.cvc.sdf 'clk_wiz_inst\.plle2_adv_inst.LOCKED' '\$auto\$xilinx_dffopt\.cc\:338\:execute\$184240.A4' --limit 10

echo '## 48: seed5-pass pass clocking all   3180.0 ps'
sdf-toolkit rank-paths result-sdf-seed5-pass/ypcb_00338_1p1_ddr3.cvc.sdf 'clk_wiz_inst\.plle2_adv_inst.LOCKED' '\$auto\$xilinx_dffopt\.cc\:338\:execute\$184242.A4' --limit 10

echo '## 49: seed1-fail fail dq_iologic lane1 dq14  3163.0 ps'
...
echo '## 50: seed1-fail fail dq_iologic lane1 dq14  3163.0 ps'
...
echo '## 51: seed2-robust robust dqs_iologic lane0 dqs0  3128.0 ps'
...
echo '## 52: seed2-robust robust dqs_iologic lane0 dqs0  3128.0 ps'
...
echo '## 53: seed4-pass pass clocking all   3124.0 ps'
sdf-toolkit rank-paths result-sdf-seed4-pass/ypcb_00338_1p1_ddr3.cvc.sdf 'clk_wiz_inst\.plle2_adv_inst.LOCKED' '\$auto\$xilinx_dffopt\.cc\:338\:execute\$184242.A4' --limit 10

echo '## 54: seed3-pass pass dqs_iologic lane0 dqs0  3122.0 ps'
...
echo '## 55: seed3-pass pass dqs_iologic lane0 dqs0  3122.0 ps'
...
echo '## 56: seed2-fail fail clocking all   3092.0 ps'
...
echo '## 57: seed2-fail fail idelayctrl all   3089.0 ps'
...
echo '## 58: seed1-fail fail dq_iologic lane1 dq8  3085.0 ps'
...
echo '## 59: seed1-fail fail dq_iologic lane1 dq8  3085.0 ps'
...
echo '## 60: seed2-robust robust clocking all   3076.0 ps'
