...
Normalized direct entries: `36216`

## Top Fail-Slower Candidate Separators

- `direct_max` `dq_iologic` `lane0` `dq1` `ctrl=` fail-pass median `566.0` ps
- `direct_max` `dq_iologic` `lane0` `dq6` `ctrl=` fail-pass median `522.5` ps
- `direct_max` `dq_iologic` `lane1` `dq8` `ctrl=` fail-pass median `446.5` ps
- `direct_max` `dq_iologic` `lane1` `dq12` `ctrl=` fail-pass median `417.5` ps
- `direct_max` `dq_iologic` `lane0` `dq5` `ctrl=` fail-pass median `412.0` ps
- `direct_max` `dq_iologic` `lane0` `dq2` `ctrl=` fail-pass median `362.5` ps
- `direct_max` `dq_iologic` `lane1` `dq11` `ctrl=` fail-pass median `332.5` ps
- `lane_spread` `dq_iologic` `lane0` `` `ctrl=` fail-pass median `331.5` ps
- `direct_max` `dq_iologic` `lane0` `dq7` `ctrl=` fail-pass median `306.0` ps
- `direct_max` `dq_iologic` `lane0` `dq3` `ctrl=` fail-pass median `301.0` ps
...
- `direct_max` `dq_iologic` `lane0` `dq4` `ctrl=` fail-pass median `233.5` ps
- `direct_max` `idelay_data_cntvaluein` `lane1` `dq10` `ctrl=1` fail-pass median `230.5` ps
- `direct_max` `dqs_iologic` `lane0` `dqs0` `ctrl=` fail-pass median `225.0` ps
- `lane_spread` `dqs_iologic` `lane0` `` `ctrl=` fail-pass median `225.0` ps
- `direct_max` `dqs_iologic` `lane1` `dqs1` `ctrl=` fail-pass median `224.0` ps
- `lane_spread` `dqs_iologic` `lane1` `` `ctrl=` fail-pass median `224.0` ps
- `direct_max` `dq_iologic` `lane0` `dq0` `ctrl=` fail-pass median `216.0` ps
- `direct_max` `idelay_data_cntvaluein` `lane0` `dq5` `ctrl=4` fail-pass median `209.5` ps
