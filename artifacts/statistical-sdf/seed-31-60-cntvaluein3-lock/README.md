...
- hardware matrix: `artifacts/hardware/ddr3_causality_matrix.csv`
- metrics directories: `artifacts/sdf-metrics/seed-31-60-cntvaluein3-lock`
- experiments with features: `30`
- semantic feature observations: `6000`
- skipped metric samples: `0`
